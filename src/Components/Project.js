        ...
        <div className="card" onClick={live ? () => open(live) : () => open(source)}>
            ...
            <div className="card-footer">
                <div className="source">
                    ...
                    {host === 'github' ? <GitHub /> : host === 'codepen' ? <svg className="codepen" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 138 26" fill="none" stroke="#000" stroke-width="2.3" stroke-linecap="round" stroke-linejoin="round">
